...
public class SavedFilesActivity extends AppCompatActivity {
    ...
    private static final String DB_URL = "https://projectnotex-default-rtdb.asia-southeast1.firebasedatabase.app/";
    ...
    private void loadData() {
        ...
        ref = FirebaseDatabase.getInstance(DB_URL).getReference("notes").child(currentUser.getUid());
                ...
                .setPositiveButton("Delete", (dialog, which) -> {
                    ...
                    for (int pos : positions) {
                        ...
                        if (key.startsWith("local_")) {
                            ...
                            FirebaseDatabase.getInstance(DB_URL).getReference("notes")
